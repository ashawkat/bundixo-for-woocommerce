...
- Renamed the plugin to Bundixo for WooCommerce (slug `bundixo-for-woocommerce`).
...
- Server-side pricing through the `bundixo/v1` REST API; discounts applied as dynamic WooCommerce coupons.
